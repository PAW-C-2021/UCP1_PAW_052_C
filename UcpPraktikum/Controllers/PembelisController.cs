...
namespace UcpPraktikum.Controllers
{
    public class PembelisController : Controller
    {
        ...
        public PembelisController(PenjualannnContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdPembeli,Nama,Alamat,TglLahir,NoHp")] Pembeli pembeli)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdPembeli,Nama,Alamat,TglLahir,NoHp")] Pembeli pembeli)
        {
