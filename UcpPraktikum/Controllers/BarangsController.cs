...
namespace UcpPraktikum.Controllers
{
    public class BarangsController : Controller
    {
        ...
        public BarangsController(PenjualannnContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdBarang,NamaBarang,JenisBarang,HargaBeli,HargaJual")] Barang barang)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdBarang,NamaBarang,JenisBarang,HargaBeli,HargaJual")] Barang barang)
        {
